document.addEventListener('DOMContentLoaded', () => {
   ...
   // Sélectionner les éléments du DOM
    ...
    // Mettre en place un objet pour stocker les données de chaque fonctionnalité
    // Les données de chaque fonctionnalité sont maintenant extraites directement des attributs data- dans le HTML
    const featuresData = {
        'quality': {
    ...
    // Fonction pour gérer les interactions (click et mouseenter)
    function handleInteraction(button) {
        // Supprimer la classe 'active' de tous les boutons et l'ajouter au bouton cliqué ou survolé
        buttons.forEach(btn => btn.classList.remove('active'));
        button.classList.add('active');

        // Récupérer la clé de la fonctionnalité et les chemins d'images des attributs data-
    ...
    buttons.forEach(button => {
        // Écouteur pour le click
        button.addEventListener('click', () => {
            handleInteraction(button);
        });
        
        // Écouteur pour le survol de la souris
        button.addEventListener('mouseenter', () => {
            handleInteraction(button);
        });
    });

    // Initialiser l'affichage avec le premier bouton actif au chargement de la page
