document.addEventListener('DOMContentLoaded', () => {
    ...
    // Sélecteurs de date dynamiques
    const checkInEl = document.getElementById('check_in_date_auth') || document.getElementById('check_in_date_guest');
    const checkOutEl = document.getElementById('check_out_date_auth') || document.getElementById('check_out_date_guest');
