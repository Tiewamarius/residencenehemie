        ...
        <section class="apartment-details-layout">
            ...
            <div class="details-right-column">
                <div class="booking-card">
                    ...
                    <form class="booking-form" action="{{ route('residences.book', ['residence' => $residence->id]) }}" method="POST"> {{-- Ajouter la méthode et l'action réelle --}}
                    ...
                    <div class="price-breakdown">
                        ...
                        <p><span>{{ number_format($minPrice ?? 0, 0, ',', ' ') }} FCFA x <span id="nights-display-breakdown">0</span> nuit(s)</span> <span><span id="price-subtotal">0</span> FCFA</span></p>
