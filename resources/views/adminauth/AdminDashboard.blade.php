...
<body
  ...
  <!-- sidenav  -->
  <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-1 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
    <div class="h-19.5">
      ...
      <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700">
        <img src="../Admin-Dashboard/assets/img/logo.png"
          ...
          alt="main_logo" />
        <span
          class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Admin-Home</span>
      </a>
    </div>
    ...
    <div class="items-center block w-auto max-h-screen   h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 " href="{{route('admin.residences')}}">
            <div
            ...
            <span
              class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Residences</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a
            ...
            <span
              class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Reservations</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a
            ...
            <span
              class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Clients</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a
            ...
            <span
              class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Equipements</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a
            ...
            <span
              class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Mon profile</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a
            ...
            <span
              class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Avis Lients</span>
          </a>
        </li>
  ...
  <main
    ...
    <!-- Navbar -->
    <nav class="fixed top-0 z-30 flex flex-wrap items-center w-full px-4 py-3 mx-auto my-1 shadow-soft-2xl rounded-blur bg-white/80 backdrop-blur-2xl backdrop-saturate-200 lg:flex-nowrap lg:justify-start">
      <div class="flex items-center justify-between w-full p-0 pl-6 mx-auto flex-wrap-inherit">
        <a class="py-2.375 text-sm mr-4 ml-4 whitespace-nowrap font-bold text-slate-700 lg:ml-0" href="{{ url('admin.dashboard') }}">
          Admin Dashboard
        </a>
        ...
        <!-- seach input -->
        <form action="#" method="GET" class="flex items-center mx-4">
          <div class="relative w-full text-gray-600 focus-within:text-gray-900">
            ...
            <input
              class="py-2 pl-10 text-sm bg-gray-100 rounded-lg focus:outline-none focus:bg-white focus:text-gray-900"
              type="search"
              name="q"
        ...
        <div navbar-menu class="items-center flex-grow overflow-hidden transition-all duration-500 ease-soft lg-max:max-h-0 basis-full lg:flex lg:basis-auto">
          <ul class="flex flex-col pl-0 mx-auto mb-0 list-none lg:flex-row xl:ml-auto">
            @auth('admin')
            <li>
              <a class="flex items-center px-4 py-2 mr-2 font-normal transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-sm text-slate-700 lg:px-2" aria-current="page" href="{{ url('admin.dashboard') }}">
                <i class="mr-1 fa fa-chart-pie opacity-60"></i>
                <!-- Tableau de Bord -->
              </a>
            </li>
            <li>
              <a class="block px-4 py-2 mr-2 font-normal transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-sm text-slate-700 lg:px-2" href="{{ url('admin.profile') }}">
    ...
    <a 
        ...
        <i class="mr-1 fas fa-sign-out-alt opacity-60"></i>
        Déconnexion
    </a>
</li>
            @else
            <li>
              <a class="block px-4 py-2 mr-2 font-normal transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-sm text-slate-700 lg:px-2" href="{{ url('admin.register') }}">
                <i class="mr-1 fas fa-user-circle opacity-60"></i>
                Inscription
              </a>
            </li>
            <li>
              <a class="block px-4 py-2 mr-2 font-normal transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-sm text-slate-700 lg:px-2" href="{{ url('admin.login') }}">
    ...
    <!-- cards -->
    <div class="w-full px-6 py-12 mx-auto" style="margin-top: 35px;">
      <!-- row 1 -->
      @yield('content')
...
<!-- github button -->
 <!-- main script file  -->
<script
  src="{{asset('../Admin-Dashboard/assets/js/soft-ui-dashboard-tailwind.js?v=1.0.5')}}"
  async></script>
