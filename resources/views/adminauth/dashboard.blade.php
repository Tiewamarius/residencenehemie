          ...
          <div class="flex flex-wrap -mx-3">
            ...
            <div
              ...
              <div
                ...
                <img
                  src="./../Admin-Dashboard/assets/img/shapes/waves-white.svg"
                ...
                <div
                  ...
                  <img
                    ...
                    src="./../Admin-Dashboard/assets/img/illustrations/rocket-white.png"
                    alt="rocket" />
                </div>
              </div>
            </div>
    ...
    <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
      <div
        ...
        <div
          ...
          style="background-image: url('./../Admin-Dashboard/assets/img/ivancik.jpg')">
          <span
                ...
                <tr>
                  <td
                    ...
                    <div class="flex px-2 py-1">
                      <div>
                        <img
                          src="./../Admin-Dashboard/assets/img/small-logos/logo-xd.svg"
                  ...
                  <td
                    ...
                    <div class="mt-2 avatar-group">
                      <a
                        ...
                        <img
                          src="./../Admin-Dashboard/assets/img/team-1.jpg"
                      ...
                      <a
                        ...
                        data-placement="bottom">
                        <img
                          src="./../Admin-Dashboard/assets/img/team-2.jpg"
                          class="w-full rounded-full"
                          alt="team2" />
                      </a>
                      <div
                      ...
                      <a
                        ...
                        data-placement="bottom">
                        <img
                          src="./../Admin-Dashboard/assets/img/team-3.jpg"
                          class="w-full rounded-full"
                          alt="team3" />
                      </a>
                      <div
                      ...
                      <a
                        ...
                        data-placement="bottom">
                        <img
                          src="./../Admin-Dashboard/assets/img/team-4.jpg"
                          class="w-full rounded-full"
                          alt="team4" />
                      </a>
                      <div
                  ...
                  <td
                    ...
                    <div class="w-3/4 mx-auto">
                      <div>
                        <div>
                          <span
                            class="text-xs font-semibold leading-tight">60%</span>
                        </div>
                      </div>
                      <div
                ...
                <tr>
                  <td
                    ...
                    <div class="flex px-2 py-1">
                      <div>
                        <img
                          src="./../Admin-Dashboard/assets/img/small-logos/logo-atlassian.svg"
                          class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                          alt="atlassian" />
                      </div>
                      <div class="flex flex-col justify-center">
                  ...
                  <td
                    ...
                    <div class="w-3/4 mx-auto">
                      <div>
                        <div>
                          <span
                            class="text-xs font-semibold leading-tight">10%</span>
                        </div>
                      </div>
                      <div
                        class="text-xs h-0.75 w-30 m-0 flex overflow-visible rounded-lg bg-gray-200">
                ...
                <tr>
                  <td
                    ...
                    <div class="flex px-2 py-1">
                      <div>
                        <img
                          src="./../Admin-Dashboard/assets/img/small-logos/logo-slack.svg"
                          class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                          alt="team7" />
                      </div>
                      <div class="flex flex-col justify-center">
                ...
                <tr>
                  <td
                    ...
                    <div class="flex px-2 py-1">
                      <div>
                        <img
                          src="./../Admin-Dashboard/assets/img/small-logos/logo-spotify.svg"
                          class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                          alt="spotify" />
                      </div>
                      <div class="flex flex-col justify-center">
                ...
                <tr>
                  <td
                    ...
                    <div class="flex px-2 py-1">
                      <div>
                        <img
                          src="./../Admin-Dashboard/assets/img/small-logos/logo-jira.svg"
                          class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                          alt="jira" />
                      </div>
                      <div class="flex flex-col justify-center">
                  ...
                  <td
                    ...
                    <div class="w-3/4 mx-auto">
                      <div>
                        <div>
                          <span
                            class="text-xs font-semibold leading-tight">25%</span>
                        </div>
                      </div>
                      <div
                        class="text-xs h-0.75 w-30 m-0 flex overflow-visible rounded-lg bg-gray-200">
                ...
                <tr>
                  <td
                    ...
                    <div class="flex px-2 py-1">
                      <div>
                        <img
                          src="./../Admin-Dashboard/assets/img/small-logos/logo-invision.svg"
                          class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                          alt="invision" />
                      </div>
                      <div class="flex flex-col justify-center">
                  ...
                  <td
                    ...
                    <div class="w-3/4 mx-auto">
                      <div>
                        <div>
                          <span
                            class="text-xs font-semibold leading-tight">40%</span>
                        </div>
                      </div>
                      <div
                        class="text-xs h-0.75 w-30 m-0 flex overflow-visible rounded-lg bg-gray-200">
